                ...
                <div class="full">
                   <div class="title-holder">
                      <div class="title-holder-cell text-left">
                         <h1 class="page-title">Literie</h1>
                         <ol class="breadcrumb">
                            <li><a href="/categories">Categories</a></li>
                            <li class="active">Literie</li>
                         </ol>
                      </div>
                   </div>
                </div>
     ...
     <div class="section padding_layout_1">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                <div class="product_list">
                    <div class="product_img"> 
                        <img class="img-responsive" src="{{asset('assets/imageschambre500/i500a.jpg')}}" alt=""> 
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                <div class="product_list">
                    <div class="product_img"> 
                        <img class="img-responsive" src="{{asset('assets/imageschambre500/i500b.jpg')}}" alt=""> 
                        <div class="overlay_pro">
                        <div class="inner_overlay">
                            <ul>
                                <li><a class="pro_funt_bt add_cart" href="https://api.whatsapp.com/send?text=Découvrez ce produit intéressant !: https://unsplash.com/fr/photos/riDA8E4S318
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                <div class="product_list">
                    <div class="product_img"> 
                        <img class="img-responsive" src="{{asset('assets/imageschambre500/i500c.jpg')}}" alt=""> 
                        <div class="overlay_pro">
                        <div class="inner_overlay">
                            <ul>
                                <li><a class="pro_funt_bt add_cart" href="https://api.whatsapp.com/send?text=Découvrez ce produit intéressant !: https://unsplash.com/fr/photos/riDA8E4S318
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                <div class="product_list">
                    <div class="product_img"> 
                        <img class="img-responsive" src="{{asset('assets/imageschambre500/i500d.jpg')}}" alt=""> 
                        <div class="overlay_pro">
                        <div class="inner_overlay">
                            <ul>
                                <li><a class="pro_funt_bt add_cart" href="https://api.whatsapp.com/send?text=Découvrez ce produit intéressant !: https://unsplash.com/fr/photos/riDA8E4S318
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                <div class="product_list">
                    <div class="product_img"> 
                        <img class="img-responsive" src="{{asset('assets/imageschambre500/i500e.jpg')}}" alt=""> 
                        <div class="overlay_pro">
                        <div class="inner_overlay">
                            <ul>
                                <li><a class="pro_funt_bt add_cart" href="https://api.whatsapp.com/send?text=Découvrez ce produit intéressant !: https://unsplash.com/fr/photos/riDA8E4S318
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                <div class="product_list">
                    <div class="product_img"> 
                        <img class="img-responsive" src="{{asset('assets/imageschambre500/i500f.jpg')}}" alt=""> 
                        <div class="overlay_pro">
                        <div class="inner_overlay">
                            <ul>
                                <li><a class="pro_funt_bt add_cart" href="https://api.whatsapp.com/send?text=Découvrez ce produit intéressant !: https://unsplash.com/fr/photos/riDA8E4S318
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                <div class="product_list">
                    <div class="product_img"> 
                        <img class="img-responsive" src="{{asset('assets/imageschambre500/i500g.jpg')}}" alt=""> 
                        <div class="overlay_pro">
                        <div class="inner_overlay">
                            <ul>
                                <li><a class="pro_funt_bt add_cart" href="https://api.whatsapp.com/send?text=Découvrez ce produit intéressant !: https://unsplash.com/fr/photos/riDA8E4S318
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                <div class="product_list">
                    <div class="product_img"> 
                        <img class="img-responsive" src="{{asset('assets/imageschambre500/i500h.jpg')}}" alt=""> 
                        <div class="overlay_pro">
                        <div class="inner_overlay">
                            <ul>
                                <li><a class="pro_funt_bt add_cart" href="https://api.whatsapp.com/send?text=Découvrez ce produit intéressant !: https://unsplash.com/fr/photos/riDA8E4S318
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                <div class="product_list">
                    <div class="product_img"> 
                        <img class="img-responsive" src="{{asset('assets/imageschambre500/i500i.jpg')}}" alt=""> 
                        <div class="overlay_pro">
                        <div class="inner_overlay">
                            <ul>
                                <li><a class="pro_funt_bt add_cart" href="https://api.whatsapp.com/send?text=Découvrez ce produit intéressant !: https://unsplash.com/fr/photos/riDA8E4S318
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                <div class="product_list">
                    <div class="product_img"> 
                        <img class="img-responsive" src="{{asset('assets/imageschambre500/i500s.jpg')}}" alt=""> 
                        <div class="overlay_pro">
                        <div class="inner_overlay">
                            <ul>
                                <li><a class="pro_funt_bt add_cart" href="https://api.whatsapp.com/send?text=Découvrez ce produit intéressant !: https://unsplash.com/fr/photos/riDA8E4S318
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                <div class="product_list">
                    <div class="product_img"> 
                        <img class="img-responsive" src="{{asset('assets/imageschambre500/i500k.jpg')}}" alt=""> 
                        <div class="overlay_pro">
                        <div class="inner_overlay">
                            <ul>
                                <li><a class="pro_funt_bt add_cart" href="https://api.whatsapp.com/send?text=Découvrez ce produit intéressant !: https://unsplash.com/fr/photos/riDA8E4S318
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                <div class="product_list">
                    <div class="product_img"> 
                        <img class="img-responsive" src="{{asset('assets/imageschambre500/i500l.jpg')}}" alt=""> 
                        <div class="overlay_pro">
                        <div class="inner_overlay">
                            <ul>
                                <li><a class="pro_funt_bt add_cart" href="https://api.whatsapp.com/send?text=Découvrez ce produit intéressant !: https://unsplash.com/fr/photos/riDA8E4S318
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                <div class="product_list">
                    <div class="product_img"> 
                        <img class="img-responsive" src="{{asset('assets/imageschambre500/i500m.jpg')}}" alt=""> 
                        <div class="overlay_pro">
                        <div class="inner_overlay">
                            <ul>
                                <li><a class="pro_funt_bt add_cart" href="https://api.whatsapp.com/send?text=Découvrez ce produit intéressant !: https://unsplash.com/fr/photos/riDA8E4S318
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                <div class="product_list">
                    <div class="product_img"> 
                        <img class="img-responsive" src="{{asset('assets/imageschambre500/i500o.jpg')}}" alt=""> 
                        <div class="overlay_pro">
                        <div class="inner_overlay">
                            <ul>
                                <li><a class="pro_funt_bt add_cart" href="https://api.whatsapp.com/send?text=Découvrez ce produit intéressant !: https://unsplash.com/fr/photos/riDA8E4S318
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                <div class="product_list">
                    <div class="product_img"> 
                        <img class="img-responsive" src="{{asset('assets/imageschambre500/i500p.jpg')}}" alt=""> 
                        <div class="overlay_pro">
                        <div class="inner_overlay">
                            <ul>
                                <li><a class="pro_funt_bt add_cart" href="https://api.whatsapp.com/send?text=Découvrez ce produit intéressant !: https://unsplash.com/fr/photos/riDA8E4S318
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                <div class="product_list">
                    <div class="product_img"> 
                        <img class="img-responsive" src="{{asset('assets/imageschambre500/i500q.jpg')}}" alt=""> 
                        <div class="overlay_pro">
                        <div class="inner_overlay">
                            <ul>
                                <li><a class="pro_funt_bt add_cart" href="https://api.whatsapp.com/send?text=Découvrez ce produit intéressant !: https://unsplash.com/fr/photos/riDA8E4S318
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                <div class="product_list">
                    <div class="product_img"> 
                        <img class="img-responsive" src="{{asset('assets/imageschambre500/i500r.jpg')}}" alt=""> 
                        <div class="overlay_pro">
                        <div class="inner_overlay">
                            <ul>
                                <li><a class="pro_funt_bt add_cart" href="https://api.whatsapp.com/send?text=Découvrez ce produit intéressant !: https://unsplash.com/fr/photos/riDA8E4S318
